...
suite("Command Test Suit", function() {
  test("get fqn from path windows",  () => {
    ...
    ParamsConverterService.targetsRoot = "c:\\Users\\Alexander\\Documents\\asep\\vscode_plugin\\opal-vscode-explorer\\server\\target\\scala-2.12\\classes";

    
    var fqn = ParamsConverterService.getFQN(filePath);
  ...
  test("get fqn from path linux",  () => {
    ...
    ParamsConverterService.targetsRoot = "/home/alex/opal-vscode-explorer/dummy/";
